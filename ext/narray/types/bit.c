...
#line 1 "tmpl/bit_binary.c"
static void
iter_bit_and(na_loop_t *const lp)
#line 3 "tmpl/bit_binary.c"
{
    size_t  n;
    size_t  p1, p2, p3;
    ssize_t s1, s2, s3;
...
/*
  ...
  @return [NArray] and of self and other.
*/
static VALUE
nary_bit_and(VALUE self, VALUE other)
#line 88 "tmpl/bit_binary.c"
{
    ndfunc_arg_in_t ain[2] = {{cT,0},{cT,0}};
    ndfunc_arg_out_t aout[1] = {{cT,0}};
    ndfunc_t ndf = { iter_bit_and, STRIDE_LOOP, 2, 1, ain, aout };
...
/*
  ...
  @overload | other
  @param [NArray,Numeric] other
  @return [NArray] or of self and other.
*/
static VALUE
nary_bit_or(VALUE self, VALUE other)
#line 88 "tmpl/bit_binary.c"
{
    ndfunc_arg_in_t ain[2] = {{cT,0},{cT,0}};
    ndfunc_arg_out_t aout[1] = {{cT,0}};
    ndfunc_t ndf = { iter_bit_or, STRIDE_LOOP, 2, 1, ain, aout };
...
/*
  ...
  @overload ^ other
  @param [NArray,Numeric] other
  @return [NArray] xor of self and other.
*/
static VALUE
nary_bit_xor(VALUE self, VALUE other)
#line 88 "tmpl/bit_binary.c"
{
    ndfunc_arg_in_t ain[2] = {{cT,0},{cT,0}};
    ndfunc_arg_out_t aout[1] = {{cT,0}};
    ndfunc_t ndf = { iter_bit_xor, STRIDE_LOOP, 2, 1, ain, aout };
...
/*
  ...
  @overload eq other
  @param [NArray,Numeric] other
  @return [NArray] eq of self and other.
*/
static VALUE
nary_bit_eq(VALUE self, VALUE other)
#line 88 "tmpl/bit_binary.c"
{
    ndfunc_arg_in_t ain[2] = {{cT,0},{cT,0}};
    ndfunc_arg_out_t aout[1] = {{cT,0}};
    ndfunc_t ndf = { iter_bit_eq, STRIDE_LOOP, 2, 1, ain, aout };
...
#line 1 "tmpl/bit_unary.c"
static void
iter_bit_not(na_loop_t *const lp)
#line 3 "tmpl/bit_unary.c"
{
    size_t  n;
    size_t  p1, p3;
    ssize_t s1, s3;
...
/*
  Unary not.
  @overload not
  @return [NArray::Bit] not of self.
*/
static VALUE
nary_bit_not(VALUE self)
#line 71 "tmpl/bit_unary.c"
{
    ndfunc_arg_in_t ain[1] = {{cT,0}};
    ndfunc_arg_out_t aout[1] = {{cT,0}};
    ndfunc_t ndf = { iter_bit_not, STRIDE_LOOP, 1, 1, ain, aout };
...
/*
  Unary copy.
  @overload copy
  @return [NArray::Bit] copy of self.
*/
static VALUE
nary_bit_copy(VALUE self)
#line 71 "tmpl/bit_unary.c"
{
    ndfunc_arg_in_t ain[1] = {{cT,0}};
    ndfunc_arg_out_t aout[1] = {{cT,0}};
    ndfunc_t ndf = { iter_bit_copy, STRIDE_LOOP, 1, 1, ain, aout };
...
#line 1 "tmpl/bit_count.c"
#undef int_t
#define int_t int64_t

static void
iter_bit_count_true(na_loop_t *const lp)
#line 6 "tmpl/bit_count.c"
{
    size_t  i;
    BIT_DIGIT *a1;
    size_t  p1;
...
Init_nary_bit()
{
    ...
    rb_define_method(cT, "&", nary_bit_and, 1);
    rb_define_method(cT, "|", nary_bit_or, 1);
    rb_define_method(cT, "^", nary_bit_xor, 1);
    rb_define_method(cT, "eq", nary_bit_eq, 1);
    rb_define_method(cT, "~", nary_bit_not, 0);
    rb_define_method(cT, "copy", nary_bit_copy, 0);
    rb_define_method(cT, "count_true", nary_bit_count_true, -1);
    rb_define_method(cT, "count_false", nary_bit_count_false, -1);
#line 726 "erb/bit.c"
